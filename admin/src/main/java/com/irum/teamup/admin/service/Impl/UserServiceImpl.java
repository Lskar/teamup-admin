package com.irum.teamup.admin.service.Impl;
...
import com.irum.teamup.admin.common.convention.exception.ClientException;
import com.irum.teamup.admin.common.enums.UserErrorCodeEnum;
import com.irum.teamup.admin.dao.entity.UserDO;
import com.irum.teamup.admin.dao.mapper.UserMapper;
...
import static com.irum.teamup.admin.common.constant.RedisCacheConstant.LOCK_USER_REGISTER_KEY;
import static com.irum.teamup.admin.common.enums.UserErrorCodeEnum.USER_NAME_EXIST;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    @Override
    public UserLoginResqDTO login(UserLoginReqDTO requestParam) {
        LambdaQueryWrapper<UserDO> queryWrapper= Wrappers.lambdaQuery(UserDO.class)
                .eq(UserDO::getUsername, requestParam.getUsername())
